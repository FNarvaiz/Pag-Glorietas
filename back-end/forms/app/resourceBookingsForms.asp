...
"Acercamos las <a href=" & dQuotes("http://vecinosdeglorietas.com.ar/contenidos/condiciones"& rec & ".pdf") & ">condiciones</a> de uso  para que las lea, complete y 72 hs antes del evento lo entregue firmado a la Guardia junto con la lista de invitados.</p>"&_
    "<table border=1>" & _
    ...
    "</table>"&_
   "<p> Muchas Gracias</p><p>Equipo de Vecinos de las Glorietas</p>"
  sendCDOMail "Familia " & neighborName, neighborMail, "Unidad " & neighborUnit & " - Familia " & neighborName & " - Confirmación de Reserva del "&rec, message, "Las glorietas - Reservas "&rec, "intendencia.glorietas@avn-nordelta.com"
...
function formResourceBookingsAfterDelete
  ...
  message = "<p>Estimada familia " & neighborName & ":<br></p>" & _
    ...
    "<p>Por cualquier duda o inconveniente mandar un mail a " & _
      "<a href=" & dQuotes("mailto:intendencia.glorietas@avn-nordelta.com") & ">intendencia.glorietas@avn-nordelta.com</a>.</p>" & _
    "<table border=1>" & _
    "<tr><td>Unidad/Lote:</td><td>" & neighborUnit & "</td></tr>" & _
    "<tr><td>Familia:</td><td>" & neighborName & "</td></tr>" & _
    "<tr><td>Fecha del evento:</td><td>" & systemDateStr(bookingDate) & "</td></tr>" & _
  ...
  sendCDOMail "Familia " & neighborName, neighborMail, "Unidad " & neighborUnit & " - Familia " & neighborName & " - Cancelación de Reserva del Club House", _
    message, "Las glorietas - Reservas Club House", "intendencia.glorietas@avn-nordelta.com"
  JSONAddMessage("Se ha enviado un e-mail de notificación al vecino.")
end function
