...
sendCDOMail "Yo", "claudiolago@yahoo.com.ar", "test", "mensaje", "Vecinos", "info@vecinosdeglorietas.com.ar"
response.end
...
SendCDOMail "info@vecinosdeglorietas.com.ar", "claudiolago@yahoo.com.ar", rs("NOMBRE").value, rs("CONTENIDO_TEXTO").value, "claudiomlago@yahoo.com.ar", _
