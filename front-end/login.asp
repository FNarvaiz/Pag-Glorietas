...
function renderloginDialog
  ...
  <!--<span class="redirect" onclick="load(this, 'registrationDialog')">Todavia no tienes cuenta ></span>-->
...
function sendRegistrationMessage(unit, name, email)
  ...
  dim message: message = "<h2>Solicitud de alta enviada</h2><h3>Nos comunicaremos a la brevedad.</h3><table border=1>" & _
    ...
    "</table><h3>Saludos Cordiales - Equipo de las glorietas</h3>"
  sendMail "Altas - Las glorietas", "intendencia.glorietas@avn-nordelta.com", "Petición de alta - Unidad/lote: " & unit, message, name, email
end function
